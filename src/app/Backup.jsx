...
const shapes = [
    {
      ...
      svg: (
        ...
        >
          <path
            d="M203.547 78.1583C249.271 105.285 282.085 93.7793 291.767 85.7168C279.036 103.605 234.209 132.202 156.747 103.479C130.388 95.165 72.7283 72.4933 0 70.9816V0.309204C90.405 0.309199 155.133 49.4358 203.547 78.1583Z"
            fill="#302B3F"
          />
        </svg>
      ),
              ...
              <div className="col-lg-4">
                <div className="d-flex align-items-start">
                  <div className="nav flex-column nav-pills me-3 tabs-menu" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <button className="nav-link" id="v-pills-settings-shape-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings-shape" type="button" role="tab" aria-controls="v-pills-settings-shape" aria-selected="false">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor"><path d="M11.9998 1L6 11H18L11.9998 1ZM11.9998 4.8873L14.4676 9H9.53232L11.9998 4.8873ZM6.75 20C5.23122 20 4 18.7688 4 17.25C4 15.7312 5.23122 14.5 6.75 14.5C8.26878 14.5 9.5 15.7312 9.5 17.25C9.5 18.7688 8.26878 20 6.75 20ZM6.75 22C9.37335 22 11.5 19.8734 11.5 17.25C11.5 14.6266 9.37335 12.5 6.75 12.5C4.12665 12.5 2 14.6266 2 17.25C2 19.8734 4.12665 22 6.75 22ZM15 15.5V19.5H19V15.5H15ZM13 21.5V13.5H21V21.5H13Z"></path></svg>
                      Shape
                    </button>
                  </div>
